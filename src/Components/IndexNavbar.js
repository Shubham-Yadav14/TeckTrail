          ...
          <div className="flex w-full justify-between h-full items-center">
            <div className="flex h-full ">
              ...
              <div className="contentNavbar  flex items-center max-md:hidden  ">
                ...
                <span className="h-full Port ">
                  <Link
                    to="/portfolio"
                    className=" w-full h-full flex justify-center items-center text-sm hover:text-black"
                  >
                    Portfolio &nbsp;
                    <svg
                  ...
                  <div
                    className="bg-white dropPort1 border-b"
                    style={{ minHeight: "385px", width: "100vw" }}
                  >
                    <Narrow class="flex ">
                      <div className="w-9/12 border-r-2">
                        <div className=" grid grid-cols-2 gap-5 text-sm max-lg:text-xs pt-5 pb-5 pr-5 ">
                          <a href="/e-commerce">
                            <div className="flex justify-center items-center hover:cursor-pointer">
                              ...
                              <div className="flex flex-col justify-center pl-3 w-7/12 max-lg:w-8/12 ">
                                ...
                                <p>
                                  We undertook a project to migrate their
                                  existing.
                                </p>
                              </div>
                            </div>
                          ...
                          <a href="/portfolio/appdevelopment">
                            <div className="flex justify-center items-center hover:cursor-pointer">
                              ...
                              <div className="flex flex-col justify-center pl-3 w-7/12 max-lg:w-8/12 ">
                                ...
                                <p>
                                  The mobile application has significantly
                                  improved.
                                </p>
                              </div>
                            </div>
                          ...
                          <a href="/ourservices/crm">
                            <div className="flex justify-center items-center gap-10 hover:cursor-pointer">
                              <img
                                src={img}
                                alt=""
                                className=" align-items-end w-3/12 max-lg:w-4/12 max-lg:h-1/2"
                              />
                              <div className="flex flex-col justify-center pl-3 w-7/12 max-lg:w-8/12 ">
                                {" "}
                                <h3 className=" font-semibold">
                                ...
                                <p>
                                  Your Trusted Partner for CRM Software Services
                                </p>
                              </div>
                            </div>
                          </a>
                      ...
                      <div className="w-3/12 flex flex-col justify-center items-center p-3 text-sm max-lg:text-xs">
                        ...
                        <div>
                          ...
                          <p>
                            Develop IT solutions based on the <br />
                            analysis phase.
                          </p>
                          <a
                            href="/viewmore"
                ...
                <span className="Serv h-full ">
                  <Link
                    to="/ourservices"
                    className="flex h-full justify-center text-sm items-center hover:text-black"
                  >
                    Services&nbsp;
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div
                    className="bg-white dropServ1  border-b hover"
                    style={{ minHeight: "385px", width: "100vw" }}
                  >
                    <Narrow class="flex">
                      <div className="w-9/12 border-r-2">
                        <div className="flex  px-3">
                          <div className="w-6/12 grid grid-cols-2 gap-5 text-sm max-lg:text-xs pt-5 pb-16 pr-5 ">
                            <a href="/brainstorming">
                              <div className="flex p-3 bg-gray-100 rounded-md hover:bg-gray-400 hover:text-white hover:cursor-pointer">
                                <img
                                  src="https://ik.imagekit.io/2q7cgnqzi/Panacee%20React%20/logo/hwd-icon-1.svg?updatedAt=1713440854392"
                                  alt=""
                                  className="w-4/12 p-1 bg-gray-300 rounded-lg"
                                />
                                <div className="pl-3">
                                  {" "}
                                  <h3 className=" font-semibold">
            ...
            <div className="flex">
              <div className="flax items-center max-md:hidden text-sm">
                ...
                <div className="pr-2">+91-965-090-0190</div>
              </div>
              <div className="flex items-center border-s border-black pl-2 max-md:border-none">
                <button
                  className=" bg-[#1351d8] py-2 px-3 rounded-full text-white"
      ...
      <Narrow>
        {
          ...
          >
            ...
            <div className="text-md  px-4">
              ...
              <div className="my-3   border-b-2 py-1">
                <button onClick={displayPortfolioMobile} className="w-full">
                  <Link
                    to="/portfolio"
                  ...
                  >
                    ...
                    <svg
                      ...
                      width="30"
                      viewBox="0 0 448 512"
                      className="dropdownsvg bg-blue-200 rounded-md"
                    >
                      <path
                        fill="#1d12f0"
                ...
                {PortMobile && (
                  <div className={`dropPort ${PortMobile ? "open" : ""}  my-2`}>
                    <div className=" grid grid-cols-1 gap-3  text-sm px-2 py-2">
                      ...
                      <a href="/portfolio/portfolio-details">
                        <div className="flex justify-center items-center hover:cursor-pointer">
                          ...
                          <div className="flex flex-col justify-center pl-3 w-7/12 max-lg:w-8/12 ">
                            {" "}
                            <h3 className=" font-semibold">SAAS Integration</h3>
                            <p>
                              We partnered with DEF to upgrade their outdated
                              IT.
                            </p>
                          </div>
                        </div>
              ...
              <div className="my-3 border-b-2 py-1">
                <button onClick={displayServMobile} className="w-full">
                  <Link
                    to="/ourservices"
